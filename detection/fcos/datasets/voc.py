...
class pascal_voc(imdb):
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(self.config['dataset_root_dir'], 'VOCdevkit')
    ...
    def gt_roidb(self):
        ...
        if os.path.exists(cache_file):
            ...
            logging.info('{} gt roidb loaded from {}'.format(self.name, cache_file))
            return roidb
    ...
    def _load_pascal_annotation(self, index):
        ...
        return {'boxes' : boxes,
                "index":index,
                "annotation":filename,
                "image":os.path.splitext(filename.replace("Annotations","JPEGImages"))[0] + self._image_ext,
